...
void OV2640_Init(void);//OV2640摄像头初始化
...
rt_uint8_t OV2640_OutSize_Set(rt_uint16_t width,rt_uint16_t height);//设置图像输出大小
rt_uint8_t OV2640_ImageWin_Set(rt_uint16_t offx,rt_uint16_t offy,rt_uint16_t width,rt_uint16_t height);//设置图像开窗大小
rt_uint8_t OV2640_ImageSize_Set(rt_uint16_t width,rt_uint16_t height);//设置图像尺寸大小
